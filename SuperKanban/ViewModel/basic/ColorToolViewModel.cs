...
namespace SuperKanban.ViewModel.basic
{
    ...
    internal class ColorToolViewModel : ViewModelBase
    {
        ...
        {
            ToggleBaseCommand = new RelayCommand<bool>(o => ApplyBase((bool)o));
            ChangeHueCommand = new RelayCommand<object>(ChangeHue,true);
            ChangeCustomHueCommand = new RelayCommand<object>(ChangeCustomColor);
            ChangeToPrimaryCommand = new RelayCommand<ColorScheme>(o => ChangeScheme(ColorScheme.Primary));
            ChangeToSecondaryCommand = new RelayCommand<ColorScheme>(o => ChangeScheme(ColorScheme.Secondary));
            ChangeToPrimaryForegroundCommand = new RelayCommand<ColorScheme>(o => ChangeScheme(ColorScheme.PrimaryForeground));
            ChangeToSecondaryForegroundCommand = new RelayCommand<ColorScheme>(o => ChangeScheme(ColorScheme.SecondaryForeground));
        ...
        private void ChangeHue(object obj)
        {
            ...
            Properties.Settings.Default.Theme = _paletteHelper.GetTheme() as Theme;
